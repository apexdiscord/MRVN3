...
module.exports = {
	...
	async execute(interaction) {
		...
		const lfgEmbed = new EmbedBuilder()
			...
			.setThumbnail(`attachment://LTM.png`)
			.setTimestamp()
			.setFooter({
		...
		if (save == 'Yes') {
			saveCasualLFGPost(interaction, 'LTM', description, playersNeeded, micRequired, playstyle, mains, gamertag);
