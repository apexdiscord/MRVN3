...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addStringOption(option =>
			option
				.setName('server-region')
				.setDescription('Server region of the lobby')
				.setRequired(true)
				.addChoices(
		...
		.addStringOption(option =>
			option.setName('game-type').setDescription('Select the game type').setRequired(true).addChoices(
				{
					name: 'Battle Royale Trios',
					value: 'Battle Royale Trios',
				},
		...
		.addStringOption(option =>
			option.setName('anonymous-mode').setDescription('Choose the correct option').setRequired(true).addChoices({ name: 'On', value: 'On' }, { name: 'Off', value: 'Off' }),
		)
		.addStringOption(option =>
			option
