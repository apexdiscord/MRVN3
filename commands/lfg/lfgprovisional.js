...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addStringOption(option => option.setName('match-number').setDescription('Set your current provisional match number').setRequired(false).addChoices(
		...
		.addStringOption(option => option.setName('previous-rank').setDescription('Set your game rank from last season').setRequired(false).addChoices(
