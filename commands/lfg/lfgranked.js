...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addStringOption(option => option.setName('rank').setDescription('Set your game rank').setRequired(false).addChoices(
	...
	async execute(interaction) {
		...
		if (selectedrank == 'Rookie') {
			embed.setThumbnail('https://cdn.discordapp.com/attachments/1102189428966965299/1102239138507407582/rookie.png');
		}
		else if (selectedrank == 'Bronze') {
			embed.setThumbnail('https://cdn.discordapp.com/attachments/1102189428966965299/1102239138507407582/bronze.png');
		}
		else if (selectedrank == 'Silver') {
			embed.setThumbnail('https://cdn.discordapp.com/attachments/1102189428966965299/1102239138507407582/silver.png');
		}
		else if (selectedrank == 'Gold') {
			embed.setThumbnail('https://cdn.discordapp.com/attachments/1102189428966965299/1102239138507407582/gold.png');
		}
		else if (selectedrank == 'Platinum') {
			embed.setThumbnail('https://cdn.discordapp.com/attachments/1102189428966965299/1102239138507407582/platinum.png');
		}
		else if (selectedrank == 'Diamond') {
			embed.setThumbnail('https://cdn.discordapp.com/attachments/1102189428966965299/1102239138507407582/diamond.png');
		}
		else {
			embed.setThumbnail('https://cdn.discordapp.com/attachments/1102189428966965299/1102239138507407582/predator.png');
		}
